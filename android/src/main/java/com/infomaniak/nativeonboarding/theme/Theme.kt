...
import com.infomaniak.core.compose.theme.selectSchemeForContrast
...
@Composable
private fun getMaterialColorScheme(isDarkTheme: Boolean, dynamicColor: Boolean): ColorScheme = when {
